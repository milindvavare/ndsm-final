                  ...
                  <div class="col-lg-12">
                     <div
                        ...
                        <div class="breadcrum-container">
                           ...
                           &gt; 
                           <span property="itemListElement" typeof="ListItem">
                              <a property="item" typeof="WebPage" title="Go to the Development Category archives." href="javascript:void(0);" class="taxonomy course-category" ><span property="name">Makeup</span></a>
...
<h4>BEST MAKEUP COURSES IN PUNE</h4>
</div>
</div>
...
<input class="tutor-form-control" value="https://ndsm.co.in/course-category/makeup/" />
</div>
<div>
...
<a href="https://www.facebook.com/sharer/sharer.php?u=https://ndsm.co.in/course-category/makeup/">   
...
<button class="tutor_share s_linkedin" style="background:#3967B6"><i class="tutor-valign-middle tutor-icon-brand-linkedin"></i> <span>Linkedin</span>
                        ...
                        <div class="tutor-course-details-tab tutor-mt-32">
                           ...
                           <div class="tutor-tab tutor-pt-24">
                              ...
                              <p><span style="font-weight: 400;">NDSM is India’s leading makeup academy offering makeup courses for those who wish to establish or upgrade their career in make-up & hairstyling industry. NDSM is a specialized training academy for professional makeup and session hairstyling providing highest standard of education to its students to build a career based on strong knowledge base. Along with academic, we at NDSM, place equal emphasis on practical training needs of students to create adequate confidence required to commence their professional career. We train students extensively in all fields of make-up including bridal make-up, fashion make-up, airbrush make-up, creative & fantasy make-up, media & editorial make-up, celebrity make-up, sfx & prosthetic make-up.</span></p>
         ...
         <ul class="tutor-course-content-list">
            <li class="tutor-course-content-list-item">
               <div class="tutor-d-flex tutor-align-center">
                  ...
                  <ul>
                     <!-- <li><h5 style="font-size: 18px;">&#9733; INSTRUCTORS</h5></li> -->
                     <li><p>Trainers at NDSM OF MAKE-UP & HAIR have an average experience  in films, fashion and bridal make-up industry. They are internationally qualified and have a strong academic record. We maintain a minimum pupil to trainer ratio of 6:1 in all our batches for personalized attention. </p></li>
                  </ul>
               </div>
            ...
            <li class="tutor-course-content-list-item">
               <div class="tutor-d-flex tutor-align-center">
                  ...
                  <ul>
                     ...
                     <li><p>Our Make-up & Hair academy is located in the education as well as bollywood hub of Mumbai with convenient access via rail, metro and road. There are several options of comfortable and secure student accommodation and food facility within 1 km distance for students coming from out of Pune.</p></li>
                  </ul>
               </div>
            ...
            <li class="tutor-course-content-list-item">
               <div class="tutor-d-flex tutor-align-center">
                  ...
                  <ul>
                     ...
                     <li><p>Our Make-up & Hair courses education and curriculum is in Hindi & English. However, even with limited or no English skills it is possible to achieve good results with the right amount of dedication and work. We are a student friendly school having flexible multi linguistic options while training.</p></li>
            ...
            <li class="tutor-course-content-list-item">
               <div class="tutor-d-flex tutor-align-center">
                  ...
                  <ul>
                     ...
                     <li><p>NDSM OF MAKE-UP & HAIR provides certification to students on completion of our respective courses. A minimum attendance and practical examination is required to graduate for certification. This Certificate is elemental for applying for a full time job or freelance industry work going forward.</p></li>
